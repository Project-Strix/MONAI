...
from monai.transforms import RandLazyLoadIamge
...
class TestLoadImage(unittest.TestCase):
    ...
    def test_nibabel_reader(self, input_param, filenames, expected_shape):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            result = RandLazyLoadIamge(image_only=True, **input_param)(filenames)
    ...
    def test_channel_dim(self, input_param, filename, expected_shape):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            result = RandLazyLoadIamge(image_only=True, **input_param)(filename)
...
class TestLoadImageMeta(unittest.TestCase):
    ...
    def test_correct(self, input_param, expected_shape, track_meta):
        ...
        r = RandLazyLoadIamge(image_only=True, roi_size=(5,5,5), prune_meta_pattern="glmax", prune_meta_sep="%", **input_param)(self.test_data)
