...
TEST_CASE_1 = [{}, ["test_image.nii.gz"], (5, 5, 5), [slice(0,5), slice(0,5), slice(5,10)]]

TEST_CASE_2 = [{}, ["test_image.nii.gz"], (1, 128, 127), (slice(0,1), slice(0,None), slice(0,-1))]

TEST_CASE_3 = [{}, ["test_image.nii.gz", "test_image2.nii.gz", "test_image3.nii.gz"], (3, 5, 5, 5), [slice(0,5), slice(0,5), slice(0,5)]]

TEST_CASE_5 = [{"reader": NibabelLazyReader()}, ["test_image.nii.gz"], (5, 5, 5), [slice(0,5), slice(0,5), slice(0,5)]]

TEST_CASE_13 = [{"reader": "nibabelreader", "channel_dim": 0}, "test_image.nii.gz", (3, 5, 5, 5), [slice(0,5), slice(0,5), slice(0,5)]]

TEST_CASE_14 = [
    {"reader": "nibabelreader", "channel_dim": -1, "ensure_channel_first": True},
    "test_image.nii.gz",
    (5, 5, 5, 3), [slice(0,5), slice(0,5), slice(0,5)]
]

TEST_CASE_15 = [{"reader": "nibabelreader", "channel_dim": 2}, "test_image.nii.gz", (5, 5, 3, 5), [slice(0,5), slice(0,5), slice(0,5)]]
...
class TestLoadImage(unittest.TestCase):
    ...
    def test_nibabel_reader(self, input_param, filenames, expected_shape, roi_slices):
    ...
    def test_channel_dim(self, input_param, filename, expected_shape, roi_slices):
